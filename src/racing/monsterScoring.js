...
export const MONSTER_TUNING = Object.freeze({
  ...
  powertrain: Object.freeze({
    ...
    redlineRpm: 6800,
    peakTorque: 1680,
    torqueCurve: Object.freeze([
      Object.freeze([0, 0.74]),
      Object.freeze([0.2, 0.98]),
      Object.freeze([0.5, 1]),
      Object.freeze([0.76, 0.82]),
      Object.freeze([1, 0.42]),
    ]),
    gearRatios: Object.freeze([3.1, 2.12, 1.55, 1.18, 0.95]),
    shiftSpeeds: Object.freeze([12.4, 18.3, 25, 31.5]),
    finalDrive: 18,
    efficiency: 0.88,
    wheelRadius: 1.05,
    mass: 5500,
