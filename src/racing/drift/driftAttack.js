...
export const DRIFT_CAR_PROFILES = Object.freeze({
  needle: Object.freeze({
    ...
    tuning: tuning({
      ...
      roadGrip: 9.15, driftGrip: 1.28, driftLateralBuild: 1.08,
      driftBreakawaySteer: 0.23, driftThrottleGripLoss: 0.3,
      driftThrottleLateralBuild: 0.22, driftYawCoupling: 2.05,
      driftYawTransition: 6.7, driftCountersteer: 0.64,
      handbrakeLateralBuild: 1.34, rollingResistance: 0.37,
  ...
  comet: Object.freeze({
    ...
    tuning: tuning({
      ...
      roadGrip: 9.0, driftGrip: 1.48, driftLateralBuild: 0.95,
      driftBreakawaySteer: 0.27, driftThrottleGripLoss: 0.26,
      driftThrottleLateralBuild: 0.18, driftYawCoupling: 1.62,
      driftYawTransition: 5.8, driftCountersteer: 0.58,
      handbrakeLateralBuild: 1.18, rollingResistance: 0.42,
  ...
  monarch: Object.freeze({
    ...
    tuning: tuning({
      ...
      roadGrip: 8.62, driftGrip: 1.72, driftLateralBuild: 0.84,
      driftBreakawaySteer: 0.32, driftThrottleGripLoss: 0.21,
      driftThrottleLateralBuild: 0.14, driftYawCoupling: 1.28,
      driftYawTransition: 4.8, driftCountersteer: 0.5,
      handbrakeLateralBuild: 1.02, rollingResistance: 0.5,
