...
export const RALLY_HANDLING_PROFILES = Object.freeze({
  ...
  drift: profile('drift-attack-linked', {
    ...
    roadGrip: 8.9,
    handbrakeDrift: true,
    driftAutoBreakaway: true,
    driftBreakawaySpeed: 10,
    driftBreakawaySteer: 0.27,
    driftGrip: 1.5,
    driftLateralBuild: 0.94,
    driftThrottleGripLoss: 0.25,
    driftThrottleLateralBuild: 0.18,
    driftYawCoupling: 1.6,
    driftYawTransition: 5.8,
    driftCountersteer: 0.58,
    handbrakeLateralBuild: 1.18,
